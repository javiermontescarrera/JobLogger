...
{
    [TestClass]
    public class BDLogTest
    {

        #region "Registro unicamente de Mensajes"

            /// <summary>
            /// Verificamos que no haya problemas al escribir el mensaje en la BD.
            ///</summary>
            [TestMethod]
            public void WriteMessageTest()
            {
                ...
                Assert.AreEqual(expectedResponse, C1.LogMessage("BD Message Test", LogType.Message));
            }
            ...
            public void OnlyMessageTest1()
            {
                ...
                try
                {
                    C1.LogMessage("BD Error Test", LogType.Error);
                }
                catch (Exception e)
                {
            ...
            public void OnlyMessageTest2()
            {
                ...
                try
                {
                    C1.LogMessage("BD Warning Test", LogType.Warning);
                }
                catch (Exception e)
                {
                    StringAssert.Contains(e.Message, "The type of the message does not match with the configured type(s)");
        ...
        #region #region "Registro unicamente de Warnings"
            ...
            public void WriteWarningTest()
            {
                ...
                Assert.AreEqual(expectedResponse, C1.LogMessage("BD Warning Test", LogType.Warning));
            }
            ...
            public void OnlyWarningTest2()
            {
                ...
                try
                {
                    C1.LogMessage("BD Message Test", LogType.Message);
                }
                catch (Exception e)
                {
                    StringAssert.Contains(e.Message, "The type of the message does not match with the configured type(s)");
        ...
        #region "Registro unicamente de Errores"
            ...
            public void WriteErrorTest()
            {
                ...
                Assert.AreEqual(expectedResponse, C1.LogMessage("BD Error Test", LogType.Error));
            }
        ...
        private JobLogger retornarLogger(configLogger config)
        {
            ...
            switch (config)
            {
                case configLogger.soloMensajes:
                    rpta = new JobLogger(false, false, true, true, false, false);
                    break;
                case configLogger.soloWarnings:
                    rpta = new JobLogger(false, false, true, false, true, false);
                    break;
                case configLogger.soloErrores:
                    rpta = new JobLogger(false, false, true, false, false, true);
                    break;
            }
