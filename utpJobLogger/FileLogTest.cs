        ...
        private JobLogger retornarLogger(configLogger config)
        {
            ...
            switch (config)
            {
                case configLogger.soloMensajes:
                    rpta = new JobLogger(true, false, false, true, false, false);
                    break;
                case configLogger.soloWarnings:
                    rpta = new JobLogger(true, false, false, false, true, false);
                    break;
                case configLogger.soloErrores:
                    rpta = new JobLogger(true, false, false, false, false, true);
                    break;
            }
